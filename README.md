# REST Client (Patched for SPARQL)

This is a forked version of REST Client that supports displaying SPARQL results (application/sparql-results+xml) as an HTML table, complete with navigation links.

The original docs are included below.
